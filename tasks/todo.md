...
- [x] 12-源码模块精读：MatchCheckerCoordinator、GuildCreation/CPQ listeners、Party.dismiss 钩子
- [x] 12-源码模块精读：OverallService、registerOverallAction、BaseScheduler 分片与典型调用链
